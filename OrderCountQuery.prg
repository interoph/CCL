/****************************************************************************************************
          Author:            Larry Canton
          Date Written:      8/5/2015
          Source File Name:  pha_oacnt
          Object Name:       <Name in CCLQUERY>
          Request #:         <Optional>
 
          Product:           <Product report addresses>
          Product Team:      Busted Knuckle Code Garage
          HNA Version:       500
          CCL Version:       2008.05.1.36
 
          Program Purpose:   Count and Display Orders Placed
 
          Tables Read:       PHA_ORD_ACT_OBS_ST OBS
          Tables Updated:    NONE
 
          Executing From:    DVDEV, EXPLORER MENU
 
          Special Notes:     ORIGINAL SOURCE CODE FROM LARRY CANTON, MH PHARMACY IT MANAGER
****************************************************************************************************
****************************************************************************************************
...
----------------------------------------------------------------------------------------------------
001		8/5/2015    Lewis Schmidt		Review and update, upload to GITHUB	
000		8/4/2015	Larry Canton		Initial Release
